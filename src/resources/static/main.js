...
var $author$project$Main$emptyPile = $elm$core$Array$empty;
...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{
			cards: $elm$core$Array$fromList(
				_List_fromArray(
					[$author$project$Main$emptyPile, $author$project$Main$emptyPile])),
...
var $author$project$Main$pull1Card = F2(
	function (index, pile) {
		return A2(
...
var $author$project$Main$push1Card = F2(
	function (card, pile) {
		return A2($elm$core$Array$push, card, pile);
	});
var $author$project$Main$moveCard2 = F2(
	function (index, _v0) {
		var pileFrom = _v0.a;
		var pileTo = _v0.b;
		...
		if (_v1.$ === 'Nothing') {
			...
			var card = _v1.a;
			return _Utils_Tuple2(
				A2($author$project$Main$pull1Card, index, pileFrom),
				A2($author$project$Main$push1Card, card, pileTo));
		}
	});
...
var $author$project$Main$moveCard = F4(
				...
				model,
				{
					cards: function () {
						if (result.$ === 'Nothing') {
							...
							return A4($author$project$Main$moveCard, pileIndexFrom, cardIndex, pileIndexTo, model.cards);
						}
					}(),
					dragDrop: model_
				}),
